class SystemMessages:
    ...
    LOG_ATTEMPT_LOGIN = "Attempting login for email:"
    LOG_USER_NOT_FOUND = "User not found for email:"
    LOG_USER_FOUND = "User found:"
    LOG_INVALID_PASSWORD = "Invalid password for email:"
    LOG_INACTIVE_USER_LOGIN = "Inactive user attempted login with email:"
